...
public class FeedsBlocklistDeBots extends MethLib{

    
    String testName = "FeedsBlocklistDeBots";
    ...
    @Test
    public void testFeedsBlocklistDeBots () throws InterruptedException, SQLException, ParseException, IOException{
      ...
      //local variables
        ...
        feedUrl = "http://lists.blocklist.de/lists/bots.txt";
        indicatorType = "IP Address";
        indicatorStatus = "Active";
        indicatorClass = "network";
        indicatorSource = "blocklist.de (Bots)";
