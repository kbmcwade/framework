...
public class ApiGetUsersCurrent extends MethLib{

    
    String testName = "ApiGetUsersCurrent";
    ...
    @Test
    public void testApiGetUsersCurrent () throws IOException, SQLException{
        
        //local variables
        Object[] response = new Object [3];
        String apiRequest="users/current";
        String method = "GET";
