...
public class FeedsDeepSightURLFraud extends MethLib{

    
    String testName = "FeedsDeepSightURLFraud";
    ...
    @Test
    public void testFeedsDeepSightURLFraud () throws InterruptedException, SQLException, IOException, ParseException{
        ...
        indicatorSource = "DeepSight Advanced URL Reputation Fraud XML Feed";
