...
public class FeedsSecureWorksCtuTipsIpWatchlist extends MethLib{

    
    String testName = "FeedsSecureWorksCtuTipsIpWatchlist";
    ...
    @Test
    public void testFeedsSecureWorksCtuTipsIpWatchlist () throws InterruptedException, SQLException, ParseException, IOException{
        ...
        feedUrl = "https://portal.secureworks.com/attackerdb/blackList?Token="+config.getProperty("swApiToken")+"&type=ip&schemaVersion=v1&format=csv&listid=14";
        feedFile = "data/feeds/secureworks/SecureWorksCTUTIPSIPWatchlist.csv";
        indicatorType = "IP Address";
        indicatorStatus = "Active";
        indicatorClass = "network";
        indicatorSource = "SecureWorks CTU TIPS IP Watchlist";
