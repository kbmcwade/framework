...
public class FeedsNoThinkSshBlacklist extends MethLib{

    
    String testName = "FeedsNoThinkSshBlacklist";
    ...
    @Test
    public void testFeedsNoThinkSshBlacklist () throws InterruptedException, SQLException, ParseException, IOException{
        ...
        feedUrl = "http://www.nothink.org/blacklist/blacklist_ssh_day.txt";
        indicatorStatus = "Active";
        indicatorSource = "NoThink SSH Blacklist";
        ...
        for(int nu=0; nu<indicators.size(); nu++){
            ...
            //determine if the indicator is a valid fqdn or ip address
            if (MethLib.validateFqdn(indicatorValue)){
                
                indicatorType = "FQDN";
                indicatorClass = "network";
                
            }else if (MethLib.validateIpAddress(indicatorValue)){
                ...
                appLogs.debug("Skipped - Indicator \'"+indicatorValue+"\' is not a valid FQDN or IP Address.");
                continue;
