...
public class FeedsSecureWorksAbuseChZeusIpTracker extends MethLib{

    
    String testName = "FeedsSecureWorksAbuseChZeusIpTracker";
    ...
    @Test
    public void testFeedsSecureWorksAbuseChZeusIpTracker () throws InterruptedException, SQLException, ParseException, IOException{
        ...
        feedUrl = "https://portal.secureworks.com/attackerdb/blackList?Token="+config.getProperty("swApiToken")+"&type=ip&schemaVersion=v1&format=csv&listid=3";
        feedFile = "data/feeds/secureworks/SecureWorksAbuseChZeusIPTracker.csv";
        indicatorType = "IP Address";
        indicatorStatus = "Active";
        indicatorClass = "network";
        indicatorSource = "SecureWorks Abuse.ch Zeus IP Tracker";
