...
public class FeedsSecureWorksCtuAptCountermeasureDomainWatchlist extends MethLib{

    
    String testName = "FeedsSecureWorksCtuAptCountermeasureDomainWatchlist";
    ...
    @Test
    public void testFeedsSecureWorksCtuAptCountermeasureDomainWatchlist () throws InterruptedException, SQLException, ParseException, IOException{
        ...
        feedUrl = "https://portal.secureworks.com/attackerdb/blackList?Token="+config.getProperty("swApiToken")+"&type=domainname&schemaVersion=v1&format=csv&listid=9";
        feedFile = "data/feeds/secureworks/SecureWorksCTUAPTCountermeasureDomainWatchlist.csv";
        indicatorType = "FQDN";
        indicatorStatus = "Active";
        indicatorClass = "network";
        indicatorSource = "SecureWorks CTU APT Countermeasure Domain Watchlist";
