...
public class FeedsSecureWorksPushDoDomainGenerationAlgorithm extends MethLib{

    
    String testName = "FeedsSecureWorksPushDoDomainGenerationAlgorithm";
    ...
    @Test
    public void testFeedsSecureWorksPushDoDomainGenerationAlgorithm () throws InterruptedException, SQLException, ParseException, IOException{
        ...
        feedUrl = "https://portal.secureworks.com/attackerdb/blackList?Token="+config.getProperty("swApiToken")+"&type=domainname&schemaVersion=v1&format=csv&listid=17";
        feedFile = "data/feeds/secureworks/SecureWorksPushDoDomainGenerationAlgorithm.csv";
        indicatorType = "FQDN";
        indicatorStatus = "Active";
        indicatorClass = "network";
        indicatorSource = "SecureWorks PushDo Domain Generation Algorithm";
