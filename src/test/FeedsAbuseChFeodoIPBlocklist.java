...
public class FeedsAbuseChFeodoIPBlocklist extends MethLib{

    
    String testName = "FeedsAbuseChFeodoIPBlocklist";
    ...
    @Test
    public void testFeedsAbuseChFeodoIPBlocklist () throws InterruptedException, SQLException, ParseException, IOException{
        ...
        feedUrl = "https://feodotracker.abuse.ch/blocklist/?download=ipblocklist";
        indicatorType = "IP Address";
        indicatorStatus = "Active";
        indicatorClass = "network";
        indicatorSource = "abuse.ch Feodo IP Blocklist";
