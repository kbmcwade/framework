...
public class FeedsDeepSightIPPhishing extends MethLib{

    
    String testName = "FeedsDeepSightIPPhishing";
    ...
    @Test
    public void testFeedsDeepSightIPPhishing () throws InterruptedException, SQLException, IOException, ParseException{
        ...
        indicatorSource = "DeepSight Advanced IP Reputation Phishing XML Feed";
        ...
        attackNameAttribute[0][1] = "DeepSight Intelligence Attack Name";
        attackNameAttribute[1][1]  = "DeepSight Intelligence Attack Category";
        attackNameAttribute[2][1]  = "DeepSight Intelligence Attack Description";
