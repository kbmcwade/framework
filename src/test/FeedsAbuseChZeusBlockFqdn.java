...
public class FeedsAbuseChZeusBlockFqdn extends MethLib{

    
    String testName = "FeedsAbuseChZeusBlockFqdn";
    ...
    @Test
    public void testFeedsAbuseChZeusBlockFqdn () throws InterruptedException, SQLException, ParseException, IOException{
        ...
        feedUrl = "https://zeustracker.abuse.ch/blocklist.php?download=domainblocklist";
        indicatorType = "FQDN";
        indicatorStatus = "Active";
        indicatorClass = "network";
        indicatorSource = "abuse.ch ZeuS Block FQDN";
