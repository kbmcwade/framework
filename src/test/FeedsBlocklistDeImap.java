...
public class FeedsBlocklistDeImap extends MethLib{

    
    String testName = "FeedsBlocklistDeImap";
    ...
    @Test
    public void testFeedsBlocklistDeImap () throws InterruptedException, SQLException, ParseException, IOException{
        ...
        feedUrl = "http://lists.blocklist.de/lists/imap.txt";
        indicatorType = "IP Address";
        indicatorStatus = "Active";
        indicatorClass = "network";
        indicatorSource = "blocklist.de (Imap)";
