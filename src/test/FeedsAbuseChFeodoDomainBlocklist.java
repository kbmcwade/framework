...
public class FeedsAbuseChFeodoDomainBlocklist extends MethLib{

    
    String testName = "FeedsAbuseChFeodoDomainBlocklist";
    ...
    @Test
    public void testFeedsAbuseChFeodoDomainBlocklist () throws InterruptedException, SQLException, ParseException, IOException{
        ...
        feedUrl = "https://feodotracker.abuse.ch/blocklist/?download=domainblocklist";
        indicatorType = "FQDN";
        indicatorStatus = "Active";
        indicatorClass = "network";
        indicatorSource = "abuse.ch Feodo Domain Blocklist";
