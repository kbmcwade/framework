...
public class ApiGetIndicators extends MethLib{

    
    String testName = "ApiGetIndicators";
    ...
    @Test
    public void testApiGetIndicators () throws IOException, SQLException{
        
        //local variables
        Object[] response = new Object [3];
        String apiRequest="indicators";
        String method = "GET";
