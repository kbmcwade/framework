...
public class FeedsSecureWorksCtuSuspectedAptDomainWatchlist extends MethLib{

    
    String testName = "FeedsSecureWorksCtuSuspectedAptDomainWatchlist";
    ...
    @Test
    public void testFeedsSecureWorksCtuSuspectedAptDomainWatchlist () throws InterruptedException, SQLException, ParseException, IOException{
        ...
        feedUrl = "https://portal.secureworks.com/attackerdb/blackList?Token="+config.getProperty("swApiToken")+"&type=domainname&schemaVersion=v1&format=csv&listid=8";
        feedFile = "data/feeds/secureworks/SecureWorksCTUSuspectedAPTDomainWatchlist.csv";
        indicatorType = "FQDN";
        indicatorStatus = "Active";
        indicatorClass = "network";
        indicatorSource = "SecureWorks CTU Suspected APT Domain Watchlist";
