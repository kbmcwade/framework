...
public class FeedsDeepSightIPFraud extends MethLib{

    
    String testName = "FeedsDeepSightIPFraud";
    ...
    @Test
    public void testFeedsDeepSightIPFraud () throws InterruptedException, SQLException, IOException, ParseException{
        ...
        List<Node> fraudDomains = new ArrayList<Node>();
        String fraudDomain = new String();
        List<Node> fraudUrls = new ArrayList<Node>();
        String fraudUrl = new String();
        ...
        indicatorSource = "DeepSight Advanced IP Reputation Fraud XML Feed";
        ...
        for (Node node : indicators) {
            ...
            //parse fraud domains node
            fraudDomains = node.selectNodes("/fraud_domains/domain");
           
            //loop through the fraud domains record nodes
            for (Node fdNode : fraudDomains) {
               
                //parse fraud domain details
                fraudDomain = fdNode.valueOf("@name");
                      
                //verify non-blank attribute values
                if (!StringUtils.isBlank(fraudDomain)){
