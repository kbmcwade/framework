...
public class FeedsEmergingThreatsIQRiskRepListIPs extends MethLib{

    
    String testName = "FeedsEmergingThreatsIQRiskRepListIPs";
    ...
    @Test
    public void testFeedsEmergingThreatsIQRiskRepListIPs () throws InterruptedException, SQLException, ParseException, IOException{
        ...
        indicatorSource = "Emerging Threats IQRisk Rep List IPs";
        ...
        for(int nu=0; nu<indicators.size(); nu++){
            ...
            if (indicators.get(nu).contentEquals("ip, category, score")){
