...
public class FeedsBlocklistDeStrongips extends MethLib{

    
    String testName = "FeedsBlocklistDeStrongips";
    ...
    @Test
    public void testFeedsBlocklistDeStrongips () throws InterruptedException, SQLException, ParseException, IOException{
        ...
        feedUrl = "http://lists.blocklist.de/lists/strongips.txt";
        indicatorType = "IP Address";
        indicatorStatus = "Active";
        indicatorClass = "network";
        indicatorSource = "blocklist.de (Strongips)";
