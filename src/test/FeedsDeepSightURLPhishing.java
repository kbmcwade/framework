...
public class FeedsDeepSightURLPhishing extends MethLib{

    
    String testName = "FeedsDeepSightURLPhishing";
    ...
    @Test
    public void testFeedsDeepSightURLPhishing () throws InterruptedException, SQLException, IOException, ParseException{
