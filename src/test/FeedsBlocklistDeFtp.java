...
public class FeedsBlocklistDeFtp extends MethLib{

    
    String testName = "FeedsBlocklistDeFtp";
    ...
    @Test
    public void testFeedsBlocklistDeFtp () throws InterruptedException, SQLException, ParseException, IOException{
        ...
        feedUrl = "http://lists.blocklist.de/lists/ftp.txt";
        indicatorType = "IP Address";
        indicatorStatus = "Active";
        indicatorClass = "network";
        indicatorSource = "blocklist.de (Ftp)";
