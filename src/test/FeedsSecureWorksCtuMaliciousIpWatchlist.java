...
public class FeedsSecureWorksCtuMaliciousIpWatchlist extends MethLib{

    
    String testName = "FeedsSecureWorksCtuMaliciousIpWatchlist";
    ...
    @Test
    public void testFeedsSecureWorksCtuMaliciousIpWatchlist () throws InterruptedException, SQLException, ParseException, IOException{
        ...
        feedUrl = "https://portal.secureworks.com/attackerdb/blackList?Token="+config.getProperty("swApiToken")+"&type=ip&schemaVersion=v1&format=csv&listid=5";
        feedFile = "data/feeds/secureworks/SecureWorksCTUMaliciousIPWatchlist.csv";
        indicatorType = "IP Address";
        indicatorStatus = "Active";
        indicatorClass = "network";
        indicatorSource = "SecureWorks CTU Malicious IP Watchlist";
