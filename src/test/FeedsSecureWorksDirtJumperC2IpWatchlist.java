...
public class FeedsSecureWorksDirtJumperC2IpWatchlist extends MethLib{

    
    String testName = "FeedsSecureWorksDirtJumperC2IpWatchlist";
    ...
    @Test
    public void testFeedsSecureWorksDirtJumperC2IpWatchlist () throws InterruptedException, SQLException, ParseException, IOException{
        ...
        feedUrl = "https://portal.secureworks.com/attackerdb/blackList?Token="+config.getProperty("swApiToken")+"&type=ip&schemaVersion=v1&format=csv&listid=19";
        feedFile = "data/feeds/secureworks/SecureWorksDirtJumperC2IPWatchlist.csv";
        indicatorType = "IP Address";
        indicatorStatus = "Active";
        indicatorClass = "network";
        indicatorSource = "SecureWorks Dirt Jumper C2 IP Watchlist";
