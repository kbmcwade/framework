...
public class FeedsAbuseChPalevoIPBlocklist extends MethLib{

    
    String testName = "FeedsAbuseChPalevoIPBlocklist";
    ...
    @Test
    public void testFeedsAbuseChPalevoIPBlocklist () throws InterruptedException, SQLException, ParseException, IOException{
        ...
        feedUrl = "https://palevotracker.abuse.ch/blocklists.php?download=ipblocklist";
        indicatorType = "IP Address";
        indicatorStatus = "Active";
        indicatorClass = "network";
        indicatorSource = "abuse.ch Palevo IP Blocklist";
