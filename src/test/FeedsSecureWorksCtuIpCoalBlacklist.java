...
public class FeedsSecureWorksCtuIpCoalBlacklist extends MethLib{

    
    String testName = "FeedsSecureWorksCtuIpCoalBlacklist";
    ...
    @Test
    public void testFeedsSecureWorksCtuIpCoalBlacklist () throws InterruptedException, SQLException, ParseException, IOException{
        ...
        feedUrl = "https://portal.secureworks.com/attackerdb/blackList?Token="+config.getProperty("swApiToken")+"&type=ip&schemaVersion=v1&format=csv&listid=1";
        feedFile = "data/feeds/secureworks/SecureWorksCTUIPCoalBlacklist.csv";
        indicatorType = "IP Address";
        indicatorStatus = "Active";
        indicatorClass = "network";
        indicatorSource = "SecureWorks CTU IP Coal Blacklist";
