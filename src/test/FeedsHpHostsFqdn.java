...
public class FeedsHpHostsFqdn extends MethLib{

    
    String testName = "FeedsHpHostsFqdn";
    ...
    @Test
    public void testFeedsHpHostsFqdn () throws InterruptedException, SQLException, ParseException, IOException{
        ...
        feedUrl = "http://hosts-file.net/hphosts-partial.txt";
        indicatorType = "FQDN";
        indicatorStatus = "Active";
        indicatorClass = "network";
        indicatorSource = "hpHosts FQDN";
        ...
        for(int nu=0; nu<indicators.size(); nu++){
            ...
            //strip 127.0.0.1 parameter from indicator
            indicatorValue = indicatorValue.replaceFirst("127.0.0.1\\s+", "");
