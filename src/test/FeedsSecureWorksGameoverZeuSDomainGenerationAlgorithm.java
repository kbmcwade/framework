...
public class FeedsSecureWorksGameoverZeuSDomainGenerationAlgorithm extends MethLib{

    
    String testName = "FeedsSecureWorksGameoverZeuSDomainGenerationAlgorithm";
    ...
    @Test
    public void testFeedsSecureWorksGameoverZeuSDomainGenerationAlgorithm () throws InterruptedException, SQLException, ParseException, IOException{
        ...
        feedUrl = "https://portal.secureworks.com/attackerdb/blackList?Token="+config.getProperty("swApiToken")+"&type=domainname&schemaVersion=v1&format=csv&listid=19";
        feedFile = "data/feeds/secureworks/SecureWorksGameoverZeuSDomainGenerationAlgorithm.csv";
        indicatorType = "FQDN";
        indicatorStatus = "Active";
        indicatorClass = "network";
        indicatorSource = "SecureWorks Gameover ZeuS Domain Generation Algorithm";
