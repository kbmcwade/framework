...
public class FeedsSecureWorksRamnitDomainGenerationAlgorithm extends MethLib{

    
    String testName = "FeedsSecureWorksRamnitDomainGenerationAlgorithm";
    ...
    @Test
    public void testFeedsSecureWorksRamnitDomainGenerationAlgorithm () throws InterruptedException, SQLException, ParseException, IOException{
        ...
        feedUrl = "https://portal.secureworks.com/attackerdb/blackList?Token="+config.getProperty("swApiToken")+"&type=domainname&schemaVersion=v1&format=csv&listid=26";
        feedFile = "data/feeds/secureworks/SecureWorksRamnitDomainGenerationAlgorithm.csv";
        indicatorType = "FQDN";
        indicatorStatus = "Active";
        indicatorClass = "network";
        indicatorSource = "SecureWorks Ramnit Domain Generation Algorithm";
