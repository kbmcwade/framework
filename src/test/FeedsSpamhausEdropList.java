...
public class FeedsSpamhausEdropList extends MethLib{

    
    String testName = "FeedsSpamhausEdropList";
    ...
    @Test
    public void testFeedsSpamhausEdropList () throws InterruptedException, SQLException, ParseException, IOException{
        ...
        feedUrl = "http://www.spamhaus.org/drop/edrop.txt";
        indicatorType = "CIDR Block";
        indicatorStatus = "Active";
        indicatorClass = "network";
        indicatorSource = "Spamhaus EDROP List";
        ...
        for(int nu=0; nu<indicators.size(); nu++){
            ...
            //strip parameter after cidr block from record
