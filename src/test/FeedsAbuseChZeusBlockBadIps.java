...
public class FeedsAbuseChZeusBlockBadIps extends MethLib{

    
    String testName = "FeedsAbuseChZeusBlockBadIps";
    ...
    @Test
    public void testFeedsAbuseChZeusBlockBadIps () throws InterruptedException, SQLException, ParseException, IOException{
        ...
        feedUrl = "https://zeustracker.abuse.ch/blocklist.php?download=badips";
        indicatorType = "IP Address";
        indicatorStatus = "Active";
        indicatorClass = "network";
        indicatorSource = "abuse.ch ZeuS Block Bad IPs";
