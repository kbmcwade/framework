...
public class FeedsAbuseChPalevoDomainBlocklist extends MethLib{

    
    String testName = "FeedsAbuseChPalevoDomainBlocklist";
    ...
    @Test
    public void testFeedsAbuseChPalevoDomainBlocklist () throws InterruptedException, SQLException, ParseException, IOException{
        ...
        feedUrl = "https://palevotracker.abuse.ch/blocklists.php?download=domainblocklist";
        indicatorType = "FQDN";
        indicatorStatus = "Active";
        indicatorClass = "network";
        indicatorSource = "abuse.ch Palevo Domain Blocklist";
