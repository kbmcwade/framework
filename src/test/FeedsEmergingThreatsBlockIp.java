...
public class FeedsEmergingThreatsBlockIp extends MethLib{

    
    String testName = "FeedsEmergingThreatsBlockIp";
    ...
    @Test
    public void testFeedsEmergingThreatsBlockIp () throws InterruptedException, SQLException, ParseException, IOException{
        ...
        feedUrl = "https://rules.emergingthreats.net/fwrules/emerging-Block-IPs.txt";
        indicatorStatus = "Active";
        indicatorSource = "Emerging Threats Block IP";
        ...
        for(int nu=0; nu<indicators.size(); nu++){
            ...
            //determine if the indicator is a valid ip address or cidr block
            if (MethLib.validateIpAddress(indicatorValue)){
                
                indicatorType = "IP Address";
                indicatorClass = "network";
                
            }else if (MethLib.validateCidrBlock(indicatorValue)){
                ...
                appLogs.debug("Skipped - Indicator \'"+indicatorValue+"\' is not a valid IP Address or CIDR Block.");
                continue;
