...
public class FeedsTorstatusBlutmagieDeAllTorNodes extends MethLib{

    
    String testName = "FeedsTorstatusBlutmagieDeAllTorNodes";
    ...
    @Test
    public void testFeedsTorstatusBlutmagieDeAllTorNodes () throws InterruptedException, SQLException, ParseException, IOException{
        ...
        feedUrl = "http://torstatus.blutmagie.de/ip_list_all.php/Tor_ip_list_ALL.csv";
        indicatorType = "IP Address";
        indicatorStatus = "Active";
        indicatorClass = "network";
        indicatorSource = "torstatus.blutmagie.de All Tor Nodes";
