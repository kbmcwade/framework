...
public class FeedsBlocklistDeAll extends MethLib{

    
    String testName = "FeedsBlocklistDeAll";
    ...
    @Test
    public void testFeedsBlocklistDeAll () throws InterruptedException, SQLException, ParseException, IOException{
        ...
        feedUrl = "http://lists.blocklist.de/lists/all.txt";
        indicatorType = "IP Address";
        indicatorStatus = "Active";
        indicatorClass = "network";
        indicatorSource = "blocklist.de (All)";
