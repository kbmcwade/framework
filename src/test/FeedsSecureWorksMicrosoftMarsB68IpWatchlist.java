...
public class FeedsSecureWorksMicrosoftMarsB68IpWatchlist extends MethLib{

    
    String testName = "FeedsSecureWorksMicrosoftMarsB68IpWatchlist";
    ...
    @Test
    public void testFeedsSecureWorksMicrosoftMarsB68IpWatchlist () throws InterruptedException, SQLException, ParseException, IOException{
        ...
        feedUrl = "https://portal.secureworks.com/attackerdb/blackList?Token="+config.getProperty("swApiToken")+"&type=ip&schemaVersion=v1&format=csv&listid=20";
        feedFile = "data/feeds/secureworks/SecureWorksMicrosoftMARSB68IPWatchlist.csv";
        indicatorType = "IP Address";
        indicatorStatus = "Active";
        indicatorClass = "network";
        indicatorSource = "SecureWorks Microsoft MARS B68 IP Watchlist";
