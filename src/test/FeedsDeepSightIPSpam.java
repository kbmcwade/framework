...
public class FeedsDeepSightIPSpam extends MethLib{

    
    String testName = "FeedsDeepSightIPSpam";
    ...
    @Test
    public void testFeedsDeepSightISpam () throws InterruptedException, SQLException, IOException, ParseException{
        ...
        indicatorSource = "DeepSight Advanced IP Reputation Spam XML Feed";
