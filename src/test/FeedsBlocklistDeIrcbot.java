...
public class FeedsBlocklistDeIrcbot extends MethLib{

    
    String testName = "FeedsBlocklistDeIrcbot";
    ...
    @Test
    public void testFeedsBlocklistDeIrcbot () throws InterruptedException, SQLException, ParseException, IOException{
        ...
        feedUrl = "http://lists.blocklist.de/lists/ircbot.txt";
        indicatorType = "IP Address";
        indicatorStatus = "Active";
        indicatorClass = "network";
        indicatorSource = "blocklist.de (Ircbot)";
