...
public class ApiGetSources extends MethLib{

    
    String testName = "ApiGetSources";
    ...
    @Test
    public void testApiGetSources () throws IOException, SQLException{
        
        //local variables
        Object[] response = new Object [3];
        String apiRequest="sources";
        String method = "GET";
