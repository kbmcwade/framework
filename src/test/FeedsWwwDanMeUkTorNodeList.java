...
public class FeedsWwwDanMeUkTorNodeList extends MethLib{

    
    String testName = "FeedsWwwDanMeUkTorNodeList";
    ...
    @Test
    public void testFeedsWwwDanMeUkTorNodeList () throws InterruptedException, SQLException, ParseException, IOException{
        ...
        feedUrl = "https://www.dan.me.uk/torlist/";
        indicatorType = "IP Address";
        indicatorStatus = "Active";
        indicatorClass = "network";
        indicatorSource = "www.dan.me.uk Tor Node List";
