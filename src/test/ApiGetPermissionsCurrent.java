...
public class ApiGetPermissionsCurrent extends MethLib{

    
    String testName = "ApiGetPermissionsCurrent";
    ...
    @Test
    public void testApiGetPermissionsCurrent () throws IOException, SQLException{
        
        //local variables
        Object[] response = new Object [3];
        String apiRequest="permissions/current";
        String method = "GET";
