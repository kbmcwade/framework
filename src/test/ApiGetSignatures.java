...
public class ApiGetSignatures extends MethLib{

    
    String testName = "ApiGetSignatures";
    ...
    @Test
    public void testApiGetSignatures () throws IOException, SQLException{
        
        //local variables
        Object[] response = new Object [3];
        String apiRequest="signatures";
        String method = "GET";
