...
public class FeedsBlocklistDeMail extends MethLib{

    
    String testName = "FeedsBlocklistDeMail";
    ...
    @Test
    public void testFeedsBlocklistDeMail () throws InterruptedException, SQLException, ParseException, IOException{
        ...
        feedUrl = "http://lists.blocklist.de/lists/mail.txt";
        indicatorType = "IP Address";
        indicatorStatus = "Active";
        indicatorClass = "network";
        indicatorSource = "blocklist.de (Mail)";
