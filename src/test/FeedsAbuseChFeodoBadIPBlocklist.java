...
public class FeedsAbuseChFeodoBadIPBlocklist extends MethLib{

    
    String testName = "FeedsAbuseChFeodoBadIPBlocklist";
    ...
    @Test
    public void testFeedsAbuseChFeodoBadIPBlocklist () throws InterruptedException, SQLException, ParseException, IOException{
        ...
        feedUrl = "https://feodotracker.abuse.ch/blocklist/?download=badips";
        indicatorType = "IP Address";
        indicatorStatus = "Active";
        indicatorClass = "network";
        indicatorSource = "abuse.ch Feodo Bad IP Blocklist";
