...
public class FeedsBlocklistDeApache extends MethLib{

    
    String testName = "FeedsBlocklistDeApache";
    ...
    @Test
    public void testFeedsBlocklistDeApache () throws InterruptedException, SQLException, ParseException, IOException{
        ...
        feedUrl = "http://lists.blocklist.de/lists/apache.txt";
        indicatorType = "IP Address";
        indicatorStatus = "Active";
        indicatorClass = "network";
        indicatorSource = "blocklist.de (Apache)";
