...
public class FeedsSpamhausDropList extends MethLib{

    
    String testName = "FeedsSpamhausDropList";
    ...
    @Test
    public void testFeedsSpamhausDropList () throws InterruptedException, SQLException, ParseException, IOException{
        ...
        feedUrl = "http://www.spamhaus.org/drop/drop.txt";
        indicatorType = "CIDR Block";
        indicatorStatus = "Active";
        indicatorClass = "network";
        indicatorSource = "Spamhaus DROP List";
