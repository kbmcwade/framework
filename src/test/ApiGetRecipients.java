...
public class ApiGetRecipients extends MethLib{

    
    String testName = "ApiGetRecipients";
    ...
    @Test
    public void testApiGetRecipients () throws IOException, SQLException{
        
        //local variables
        Object[] response = new Object [3];
        String apiRequest="recipients";
        String method = "GET";
