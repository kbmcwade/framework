...
public class FeedsAbuseChZeusBlockIps extends MethLib{

    
    String testName = "FeedsAbuseChZeusBlockIps";
    ...
    @Test
    public void testFeedsAbuseChZeusBlockIps () throws InterruptedException, SQLException, ParseException, IOException{
        ...
        feedUrl = "https://zeustracker.abuse.ch/blocklist.php?download=ipblocklist";
        indicatorType = "IP Address";
        indicatorStatus = "Active";
        indicatorClass = "network";
        indicatorSource = "abuse.ch ZeuS Block IPs";
