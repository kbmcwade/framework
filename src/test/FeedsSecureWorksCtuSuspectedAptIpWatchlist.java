...
public class FeedsSecureWorksCtuSuspectedAptIpWatchlist extends MethLib{

    
    String testName = "FeedsSecureWorksCtuSuspectedAptIpWatchlist";
    ...
    @Test
    public void testFeedsSecureWorksCtuSuspectedAptIpWatchlist () throws InterruptedException, SQLException, ParseException, IOException{
        ...
        feedUrl = "https://portal.secureworks.com/attackerdb/blackList?Token="+config.getProperty("swApiToken")+"&type=ip&schemaVersion=v1&format=csv&listid=6";
        feedFile = "data/feeds/secureworks/SecureWorksCTUSuspectedAPTIPWatchlist.csv";
        indicatorType = "IP Address";
        indicatorStatus = "Active";
        indicatorClass = "network";
        indicatorSource = "SecureWorks CTU Suspected APT IP Watchlist";
