...
public class FeedsSecureWorksAbuseChFeodoIpTracker extends MethLib{

    
    String testName = "FeedsSecureWorksAbuseChFeodoIpTracker";
    ...
    @Test
    public void testFeedsSecureWorksAbuseChFeodoIpTracker () throws InterruptedException, SQLException, ParseException, IOException{
        ...
        feedUrl = "https://portal.secureworks.com/attackerdb/blackList?Token="+config.getProperty("swApiToken")+"&type=ip&schemaVersion=v1&format=csv&listid=26";
        feedFile = "data/feeds/secureworks/SecureWorksAbuseChFeodoIPTracker.csv";
        indicatorType = "IP Address";
        indicatorStatus = "Active";
        indicatorClass = "network";
        indicatorSource = "SecureWorks Abuse.ch Feodo IP Tracker";
