...
public class ApiGetGroups extends MethLib{

    
    String testName = "ApiGetGroups";
    ...
    @Test
    public void testApiGetGroups () throws IOException, SQLException{
        
        //local variables
        Object[] response = new Object [3];
        String apiRequest="groups";
        String method = "GET";
