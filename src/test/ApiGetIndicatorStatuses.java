...
public class ApiGetIndicatorStatuses extends MethLib{

    
    String testName = "ApiGetIndicatorStatuses";
    ...
    @Test
    public void testApiGetIndicatorStatuses () throws IOException, SQLException{
        
        //local variables
        Object[] response = new Object [3];
        String apiRequest="indicator/statuses";
        String method = "GET";
