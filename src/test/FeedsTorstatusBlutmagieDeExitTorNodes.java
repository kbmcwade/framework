...
public class FeedsTorstatusBlutmagieDeExitTorNodes extends MethLib{

    
    String testName = "FeedsTorstatusBlutmagieDeExitTorNodes";
    ...
    @Test
    public void testFeedsTorstatusBlutmagieDeExitTorNodes () throws InterruptedException, SQLException, ParseException, IOException{
        ...
        feedUrl = "http://torstatus.blutmagie.de/ip_list_exit.php/Tor_ip_list_EXIT.csv";
        indicatorType = "IP Address";
        indicatorStatus = "Active";
        indicatorClass = "network";
        indicatorSource = "torstatus.blutmagie.de Exit Tor Nodes";
