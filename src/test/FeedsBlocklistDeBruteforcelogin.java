...
public class FeedsBlocklistDeBruteforcelogin extends MethLib{

    
    String testName = "FeedsBlocklistDeBruteforcelogin";
    ...
    @Test
    public void testFeedsBlocklistDeBruteforcelogin () throws InterruptedException, SQLException, ParseException, IOException{
        ...
        feedUrl = "http://lists.blocklist.de/lists/bruteforcelogin.txt";
        indicatorType = "IP Address";
        indicatorStatus = "Active";
        indicatorClass = "network";
        indicatorSource = "blocklist.de (Bruteforcelogin)";
