...
public class FeedsAbuseChZeusBlockBadFqdns extends MethLib{

    
    String testName = "FeedsAbuseChZeusBlockBadFqdns";
    ...
    @Test
    public void testFeedsAbuseChZeusBlockBadFqdns () throws InterruptedException, SQLException, ParseException, IOException{
        ...
        feedUrl = "https://zeustracker.abuse.ch/blocklist.php?download=baddomains";
        indicatorType = "FQDN";
        indicatorStatus = "Active";
        indicatorClass = "network";
        indicatorSource = "abuse.ch ZeuS Block Bad FQDNs";
