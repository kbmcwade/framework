...
public class ApiGetWhitelistRulesCount extends MethLib{

    
    String testName = "ApiGetWhitelistRulesCount";
    ...
    @Test
    public void testApiGetWhitelistRulesCount () throws IOException, SQLException{
        
        //local variables
        Object[] response = new Object [3];
        String apiRequest="whitelist/rules/count";
        String method = "GET";
