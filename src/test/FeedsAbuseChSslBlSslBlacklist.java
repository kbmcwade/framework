...
public class FeedsAbuseChSslBlSslBlacklist extends MethLib{

    
    String testName = "FeedsAbuseChSslBlSslBlacklist";
    ...
    @Test
    public void testFeedsAbuseChSslBlSslBlacklist () throws InterruptedException, SQLException, ParseException, IOException{
        ...
        indicatorClass = "host";
        indicatorSource = "abuse.ch SSLBL SSL Blacklist";
        attributeKeyA = "Malware Family";
        ...
        for(int nu=0; nu<indicators.size(); nu++){
            ...
            //parse comma-separated record for indicator value and malware family 
            indicatorRecord = indicators.get(nu).split(",");
            indicatorValue = indicatorRecord[1];
            attributeValueA = indicatorRecord[2];
