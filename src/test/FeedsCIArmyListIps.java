...
public class FeedsCIArmyListIps extends MethLib{

    
    String testName = "FeedsCIArmyListIps";
    ...
    @Test
    public void testFeedsCIArmyListIps () throws InterruptedException, SQLException, ParseException, IOException{
        ...
        feedUrl = "http://www.ciarmy.com/list/ci-badguys.txt";
        indicatorType = "IP Address";
        indicatorStatus = "Active";
        indicatorClass = "network";
        indicatorSource = "CI Army List IPs";
