...
public class FeedsSecureWorksAbuseChZeusDomainTracker extends MethLib{

    
    String testName = "FeedsSecureWorksAbuseChZeusDomainTracker";
    ...
    @Test
    public void testFeedsSecureWorksAbuseChZeusDomainTracker () throws InterruptedException, SQLException, ParseException, IOException{
        ...
        feedUrl = "https://portal.secureworks.com/attackerdb/blackList?Token="+config.getProperty("swApiToken")+"&type=domainname&schemaVersion=v1&format=csv&listid=3";
        feedFile = "data/feeds/secureworks/SecureWorksAbuseChZeusDomainTracker.csv";
        indicatorType = "FQDN";
        indicatorStatus = "Active";
        indicatorClass = "network";
        indicatorSource = "SecureWorks Abuse.ch Zeus Domain Tracker";
