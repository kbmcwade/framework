...
public class FeedsDeepSightURLCnC extends MethLib{

    
    String testName = "FeedsDeepSightURLCnC";
    ...
    @Test
    public void testFeedsDeepSightURLCnC () throws InterruptedException, SQLException, IOException, ParseException{
        ...
        indicatorSource = "DeepSight Advanced URL Reputation CnC XML Feed";
