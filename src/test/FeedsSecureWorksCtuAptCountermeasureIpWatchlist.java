...
public class FeedsSecureWorksCtuAptCountermeasureIpWatchlist extends MethLib{

    
    String testName = "FeedsSecureWorksCtuAptCountermeasureIpWatchlist";
    ...
    @Test
    public void testFeedsSecureWorksCtuAptCountermeasureIpWatchlist () throws InterruptedException, SQLException, ParseException, IOException{
        
        //local variables
        String feedUrl = new String();
        String feedFile = new String();
        List<String> indicators = new ArrayList<String>();
        String[] indicatorRecord = new String[8];
        ...
        feedUrl = "https://portal.secureworks.com/attackerdb/blackList?Token="+config.getProperty("swApiToken")+"&type=ip&schemaVersion=v1&format=csv&listid=8";
        feedFile = "data/feeds/secureworks/SecureWorksCTUAPTCountermeasureIPWatchlist.csv";
        indicatorType = "IP Address";
        indicatorStatus = "Active";
        indicatorClass = "network";
        indicatorSource = "SecureWorks CTU APT Countermeasure IP Watchlist";
