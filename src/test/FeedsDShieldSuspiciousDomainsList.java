...
public class FeedsDShieldSuspiciousDomainsList extends MethLib{

    
    String testName = "FeedsDShieldSuspiciousDomainsList";
    ...
    @Test
    public void testFeedsDShieldSuspiciousDomainsList () throws InterruptedException, SQLException, ParseException, IOException{
        ...
        feedUrl = "https://isc.sans.edu/feeds/suspiciousdomains_High.txt";
        indicatorType = "FQDN";
        indicatorStatus = "Active";
        indicatorClass = "network";
        indicatorSource = "DShield Suspicious Domains List";
        ...
        for(int nu=0; nu<indicators.size(); nu++){
            ...
            //skip comments and blank lines and site header
            if (indicatorValue.startsWith("#") || StringUtils.isBlank(indicatorValue) || indicatorValue.contentEquals("Site")){
