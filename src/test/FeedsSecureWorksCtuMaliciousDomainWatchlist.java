...
public class FeedsSecureWorksCtuMaliciousDomainWatchlist extends MethLib{

    
    String testName = "FeedsSecureWorksCtuMaliciousDomainWatchlist";
    ...
    @Test
    public void testFeedsSecureWorksCtuMaliciousDomainWatchlist () throws InterruptedException, SQLException, ParseException, IOException{
        ...
        feedUrl = "https://portal.secureworks.com/attackerdb/blackList?Token="+config.getProperty("swApiToken")+"&type=domainname&schemaVersion=v1&format=csv&listid=7";
        feedFile = "data/feeds/secureworks/SecureWorksCTUMaliciousDomainWatchlist.csv";
        indicatorType = "FQDN";
        indicatorStatus = "Active";
        indicatorClass = "network";
        indicatorSource = "SecureWorks CTU Malicious Domain Watchlist";
