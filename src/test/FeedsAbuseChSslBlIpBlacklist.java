...
public class FeedsAbuseChSslBlIpBlacklist extends MethLib{

    
    String testName = "FeedsAbuseChSslBlIpBlacklist";
    ...
    @Test
    public void testFeedsAbuseChSslBlIpBlacklist () throws InterruptedException, SQLException, ParseException, IOException{
        ...
        feedUrl = "https://sslbl.abuse.ch/blacklist/sslipblacklist.csv";
        indicatorType = "IP Address";
        indicatorStatus = "Active";
        indicatorClass = "network";
        indicatorSource = "abuse.ch SSLBL IP Blacklist";
        attributeKeyA = "Port";
        attributeKeyB = "Malware Family";
        ...
        for(int nu=0; nu<indicators.size(); nu++){
            ...
            if (indicators.get(nu).startsWith("#") || StringUtils.isBlank(indicators.get(nu))){
                
                continue;
                
            }                        
            
            //parse comma-separated record for indicator value, port, and malware family
            ...
            //check db for malware family attribute          
