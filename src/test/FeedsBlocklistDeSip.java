...
public class FeedsBlocklistDeSip extends MethLib{

    
    String testName = "FeedsBlocklistDeSip";
    ...
    @Test
    public void testFeedsBlocklistDeSip () throws InterruptedException, SQLException, ParseException, IOException{
        ...
        feedUrl = "http://lists.blocklist.de/lists/sip.txt";
        indicatorType = "IP Address";
        indicatorStatus = "Active";
        indicatorClass = "network";
        indicatorSource = "blocklist.de (Sip)";
