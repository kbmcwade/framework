...
public class FeedsSecureWorksCryptolockerDomainGenerationAlgorithm extends MethLib{

    
    String testName = "FeedsSecureWorksCryptolockerDomainGenerationAlgorithm";
    ...
    @Test
    public void testFeedsSecureWorksCryptolockerDomainGenerationAlgorithm () throws InterruptedException, SQLException, ParseException, IOException{
        ...
        feedUrl = "https://portal.secureworks.com/attackerdb/blackList?Token="+config.getProperty("swApiToken")+"&type=domainname&schemaVersion=v1&format=csv&listid=21";
        feedFile = "data/feeds/secureworks/SecureWorksCryptolockerDomainGenerationAlgorithm.csv";
        indicatorType = "FQDN";
        indicatorStatus = "Active";
        indicatorClass = "network";
        indicatorSource = "SecureWorks Cryptolocker Domain Generation Algorithm";
