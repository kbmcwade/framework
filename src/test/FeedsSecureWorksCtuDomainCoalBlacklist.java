...
public class FeedsSecureWorksCtuDomainCoalBlacklist extends MethLib{

    
    String testName = "FeedsSecureWorksCtuDomainCoalBlacklist";
    ...
    @Test
    public void testFeedsSecureWorksCtuDomainCoalBlacklist () throws InterruptedException, SQLException, ParseException, IOException{
        ...
        feedUrl = "https://portal.secureworks.com/attackerdb/blackList?Token="+config.getProperty("swApiToken")+"&type=domainname&schemaVersion=v1&format=csv&listid=1";
        feedFile = "data/feeds/secureworks/SecureWorksCTUDomainCoalBlacklist.csv";
        indicatorType = "FQDN";
        indicatorStatus = "Active";
        indicatorClass = "network";
        indicatorSource = "SecureWorks CTU Domain Coal Blacklist";
