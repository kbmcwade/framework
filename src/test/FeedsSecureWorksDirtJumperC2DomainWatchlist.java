...
public class FeedsSecureWorksDirtJumperC2DomainWatchlist extends MethLib{

    
    String testName = "FeedsSecureWorksDirtJumperC2DomainWatchlist";
    ...
    @Test
    public void testFeedsSecureWorksDirtJumperC2DomainWatchlist () throws InterruptedException, SQLException, ParseException, IOException{
        ...
        feedUrl = "https://portal.secureworks.com/attackerdb/blackList?Token="+config.getProperty("swApiToken")+"&type=domainname&schemaVersion=v1&format=csv&listid=20";
        feedFile = "data/feeds/secureworks/SecureWorksDirtJumperC2DomainWatchlist.csv";
        indicatorType = "FQDN";
        indicatorStatus = "Active";
        indicatorClass = "network";
        indicatorSource = "SecureWorks Dirt Jumper C2 Domain Watchlist";
